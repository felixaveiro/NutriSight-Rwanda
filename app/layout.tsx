...
export const metadata: Metadata = {
  title: "NutriSight Rwanda - AI-Powered Nutrition Intelligence",
            ...
            <div className="container mx-auto px-4 py-8">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="space-y-4">
                  <h3 className="font-semibold text-foreground">NutriSight Rwanda</h3>
              ...
              <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
                <p>&copy; 2025 NutriSight Rwanda. Empowering nutrition security through data intelligence.</p>
              </div>
            </div>
          </footer>
        </div>
